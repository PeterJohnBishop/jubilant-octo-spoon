...
class DesktopCircularImageWithDropShadowWidget extends StatelessWidget {
  const DesktopCircularImageWithDropShadowWidget({super.key});
...
class MobileCircularImageWithDropShadowWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    double imageWidth = (width * 0.6).clamp(200, 350);
